...
import bioc
import pandas as pd
from MIRQI.negbio.pipeline import text2bioc, ssplit, section_split
...
class Loader(object):
    ...
    def __init__(self, report_pair=None, reports_path=None, extract_impression=False):
        self.reports_path = reports_path
        self.report_pair = report_pair
    ...
    def load(self):
        ...
        elif self.report_pair:
            reports = self.report_pair

        assert reports is not None, ('A pair of reports (reference + candidate) is required.')
