...
from MIRQI.negbio.pipeline import parse, ptb2ud, negdetect
from MIRQI.negbio.neg import semgraph, propagator, neg_detector
from MIRQI.negbio import ngrex
...
class Classifier(object):
    ...
    def classify(self, collection):
        ...
        for document in documents:
            ...
            # Extract the attributes for observations
            negdetect.extractAttribute(document, self.detector)
